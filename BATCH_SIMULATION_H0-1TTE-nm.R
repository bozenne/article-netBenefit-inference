...
## setwd(path)
## source("BATCH_SIMULATION-H0-1TTE-nm.R")
## sbatch -a 1-10 -J 'mytest' --output=/dev/null --error=/dev/null R CMD BATCH --vanilla BATCH_SIMULATION-H0-1TTE-nm.R /dev/null 
...
## * path
path <- "."
path.res <- file.path(path,"Results","H0-1TTE-nm")
...
path.output <- file.path(path,"output","H0-1TTE-nm")
