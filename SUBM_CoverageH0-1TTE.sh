...
#$ -o output/CoverageH0-1TTE/   # Direct output to subdirectory
#$ -e output/CoverageH0-1TTE/   # Direct output to subdirectory

R CMD BATCH BATCH_CoverageH0-1TTE.R output/CoverageH0-1TTE/$JOB_NAME-I-$SGE_TASK_ID.Rout --no-restore --no-save

## go to directory    ## cd Cluster/GPC/Article-inference-Ustatistic/
## clean outputs      ## rm -r ./output/CoverageH0-1TTE/*
## clean results      ## rm -r ./Results/CoverageH0-1TTE/*
## submission command ## qsub SUBM_CoverageH0-1TTE.sh

## submission output  ## Your job-array 13516.1-40:1 ("CoverageH0-1TTE") has been submitted
